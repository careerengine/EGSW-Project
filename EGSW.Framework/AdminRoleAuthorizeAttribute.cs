...
namespace EGSW.Framework
{
    ...
    public class AdminRoleAuthorizeAttribute : FilterAttribute, IAuthorizationFilter
    {
        private readonly bool _dontValidate;


        public AdminRoleAuthorizeAttribute()
            : this(false)
        {
        }

        public AdminRoleAuthorizeAttribute(bool dontValidate)
        {
        ...
        public virtual bool HasAdminAccess(AuthorizationContext filterContext)
        {
            ...
            bool result = permissionService.AuthorizeAdminRoleAccess();
            return result;
        }
    }
}
