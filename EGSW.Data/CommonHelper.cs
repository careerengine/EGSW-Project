...
namespace EGSW.Data
{
    ...
    public partial class CommonHelper
    {
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new EGSWException("Email is not valid.");
            }
        ...
        public static object To(object value, Type destinationType, CultureInfo culture)
        {
            if (value != null)
            {
                ...
                TypeConverter destinationConverter = GetEgswCustomTypeConverter(destinationType);
                TypeConverter sourceConverter = GetEgswCustomTypeConverter(sourceType);
        ...
        public static TypeConverter GetEgswCustomTypeConverter(Type type)
        {
