...
namespace EGSW.Data.Customers
{
    public static class CustomerExtensions
    {
        ...
        public static bool IsSearchEngineAccount(this Customer customer)
        {
            ...
            var result = customer.Email.Equals("search@gmail.com", StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        public static bool IsAgent(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return IsInCustomerRole(customer, SystemCustomerRoleNames.Agent, onlyActiveCustomerRoles);
        }
